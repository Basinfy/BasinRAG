# Auditoria histórica BasinRAG 1.0.4

> Arquivado: este relatório descreve um checkout e protocolo anteriores. Não é uma auditoria da release 1.1.0; consulte o código e os testes atuais. As métricas abaixo são históricas e não constituem claims vigentes.
