...
\begin{definition}[Operador Sucessor Determinístico]
...
\end{equation}
em que $\phi(v)$ identifica o predecessor estrutural imediato de $v$ na esteira discursiva do autor.
\end{definition}
...
\end{equation}
Os candidatos de topo são reclassificados por um Cross-Encoder multilíngue mMARCO antes da composição final do prompt.
...
\end{equation}
com $\alpha_{\text{ppr}} = 0,85$. O confinamento estrito da difusão à bacia induzida impede que a massa de probabilidade seja desviada por nós externos.
